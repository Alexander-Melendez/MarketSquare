...
// import ReactDOM from 'react-dom'; removed to reduce unused errors

// Redirect removed from 'react-router-dom' to reduce unused errors
import { BrowserRouter as Router, Route, Switch, Link } from 'react-router-dom';
// Card removed from 'react-bootstrap' to reduce unused errors
import { Button, Navbar, Container, FormControl, Form, Nav } from 'react-bootstrap';
import 'bootstrap/dist/css/bootstrap.min.css';

import NewListingPage from './pages/NewListingPage';
// import MakeListing from './components/MakeListing'; removed to reduce unused errors
    ...
    <Router basename='Home'>
      <div>
        <Navbar bg="dark" variant="dark" sticky="top">
            <Link to='/' style={{ textDecoration: 'red' }}><Navbar.Brand>Home</Navbar.Brand></Link>
            <Route path='/' exact>
